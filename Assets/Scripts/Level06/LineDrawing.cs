...
public class LineDrawing : MonoBehaviour
{
    ...
    private void DrawingInputHandler()
    {
        ...
        if (_isDrawing && Input.GetMouseButton(0))
        {
            ...
            {
                // MarkLineInvalid(); will implement the red waarning line after figuring out the line rendering issues.
                ResetDrawing();
            }
        }
    ...
    //private void MarkLineInvalid()
    //{
    //    if (_currentLine != null)
    //    {
    //        _currentLine.material = warningLineMaterial;
    //    }
    //}
